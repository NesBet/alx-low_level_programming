 ...
 * Description: Exit code 98 if file isn't ELF.
 */
 ...
 * @e_ident: Pointer to an array containing ELF file's class.
 */
 ...
 *
 * Description: Exit code 98 if file is non-displayable.
 */
 ...
 *
 * Return: 0 for success, else for error.
 * Description: Functions fails if it is not an ELF file.
 */
